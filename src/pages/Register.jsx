        ...
        <div style={styles.page}>
            <style>{`
                ...
                * { box-sizing: border-box; }
                ...
                .register-btn:hover { opacity: 0.88; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.4); }
            ...
            <div style={styles.content}>
                ...
                <div style={styles.leftSide}>
                    ...
                    <div style={styles.dotsRow}>
                        {slides.map((s, i) => (
                            <button key={i} className="sport-dot"
                    ...
                    <div style={styles.benefitsBox}>
                        {[
                            ...
                            { icon: '📱', text: 'QR code entry pass' },
                            { icon: '🔒', text: 'Secure & easy payments' },
                            { icon: '🏟️', text: 'Access to 14+ turfs' },
                        ].map((b, i) => (
                ...
                <div style={styles.rightSide}>
                    <div className="form-wrap" style={styles.glassCard}>
                        ...
                        <form onSubmit={handleRegister}>
                            {[
                                ...
                                <div key={f.name} style={styles.field}>
                                    ...
                                    <div style={{
                                        ...styles.inputBox,
                                        borderColor: formData[f.name] ? current.color + '88' : 'rgba(255,255,255,0.1)',
                        ...
                        <Link to="/login" style={{textDecoration: 'none'}}>
                            <button className="login-link-btn" style={{
                                ...styles.loginLinkBtn,
...
const styles = {
    ...
    logoText: {
        ...
        letterSpacing: '4px', textShadow: '0 2px 20px rgba(0,0,0,0.5)',
    },
    ...
    heroTitle: {
        fontFamily: "'Bebas Neue', sans-serif",
        fontSize: '52px', letterSpacing: '5px',
        margin: '0 0 8px 0', textShadow: '0 4px 30px rgba(0,0,0,0.5)',
    },
    ...
    rightSide: { width: '420px', flexShrink: 0 },
    glassCard: {
    ...
    cardHeader: { padding: '24px 28px 0 28px', marginBottom: '14px' },
    cardTitle: {
        fontFamily: "'Bebas Neue', sans-serif",
        color: '#ffffff', fontSize: '32px',
    ...
    pillsRow: { display: 'flex', gap: '8px', padding: '0 28px', marginBottom: '16px', flexWrap: 'wrap' },
    pill: { fontSize: '20px', padding: '7px 11px', borderRadius: '10px', cursor: 'pointer', background: 'transparent' },
    ...
    field: { padding: '0 28px', marginBottom: '12px' },
    label: {
    ...
    divider: {
        display: 'flex', alignItems: 'center',
        gap: '12px', padding: '16px 28px 0 28px',
    },
    ...
    backHome: { textAlign: 'center', padding: '14px 28px 22px 28px', margin: 0 },
};
