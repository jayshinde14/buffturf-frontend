...
function TurfDetail() {
    ...
    const handleBooking = () => {
        ...
        navigate('/booking', {
            state: { turf, slot: selectedSlot, date: selectedDate }
        });
    };
        ...
        <div style={styles.page}>
            ...
            <div style={{...styles.banner, background: `linear-gradient(135deg, ${color}15 0%, #050a14 70%)`}}>
                <div style={styles.bannerInner}>
                    ...
                    <div style={styles.bannerRow}>
                        {/* Emoji Box */}
                        <div style={{...styles.emojiBox, border: `2px solid ${color}44`, background: color + '11'}}>
                            <span style={{fontSize: '80px'}}>{getEmoji(turf.sportType)}</span>
                        </div>
                        ...
                        <div style={styles.bannerInfo}>
                            ...
                            <div style={styles.statsBar}>
                                <div style={styles.statBox}>
                                    <p style={{...styles.statVal, color}}>₹{turf.pricePerHour}</p>
                                    <p style={styles.statLbl}>Per Hour</p>
                                </div>
                                <div style={styles.statDiv}/>
                                <div style={styles.statBox}>
                                    <p style={{...styles.statVal, color: '#22c55e'}}>{availableSlots.length}</p>
                                    <p style={styles.statLbl}>Available Today</p>
                                </div>
                                <div style={styles.statDiv}/>
                                <div style={styles.statBox}>
                                    <p style={{...styles.statVal, color: '#ef4444'}}>{bookedSlots.length}</p>
                                    <p style={styles.statLbl}>Booked</p>
                                </div>
                                <div style={styles.statDiv}/>
                                <div style={styles.statBox}>
                                    <p style={{...styles.statVal, color: '#f59e0b'}}>10</p>
            ...
            <div style={styles.main}>
                ...
                <div style={styles.slotsSection}>
                    <div style={styles.slotsTitleRow}>
                        <h2 style={styles.secTitle}>⏰ Select Time Slot</h2>
                        <div style={styles.legend}>
                            <span style={styles.legendItem}>
                                <span style={{...styles.legendDot, background: '#22c55e'}}/>Available
                            </span>
                            <span style={styles.legendItem}>
                                <span style={{...styles.legendDot, background: '#ef4444'}}/>Booked
                            </span>
                            <span style={styles.legendItem}>
                                <span style={{...styles.legendDot, background: color}}/>Selected
                            </span>
                        </div>
                    </div>
                    ...
                    {loadingSlots ? (
                        ...
                        <div style={styles.noSlots}>
                            ...
                            <p style={{color: '#64748b', fontSize: '14px'}}>
                                Admin hasn't generated slots for this date yet. Try another date!
                            </p>
                        </div>
                    ) : (
                            ...
                            {slots.map(slot => {
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            ...styles.slotBtn,
                                            background: isBooked ? '#1a0808' :
                                                        isSelected ? color + '22' : '#111827',
                                            border: `2px solid ${isBooked ? '#ef444433' :
                                                        isSelected ? color : '#1e293b'}`,
                                    ...
                                    >
                                        ...
                                        <div style={{
                                            ...
                                            background: isBooked ? '#ef444422' :
                                                        isSelected ? color + '33' : '#22c55e22',
                                            color: isBooked ? '#ef4444' :
                ...
                {/* Sticky Booking Bar */}
                {selectedSlot && (
                    <div style={{...styles.bookingBar, borderTop: `3px solid ${color}`}}>
...
const styles = {
    ...
    bookingBar: {
        ...
        background: '#111827', padding: '16px 32px',
        display: 'flex', justifyContent: 'space-between',
