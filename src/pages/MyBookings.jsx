...
//                                 <div>
//                                     <h3 style={styles.turfName}>
//                                         🏟️ {booking.turf?.name}
//                                     </h3>
//                                     <p style={styles.bookingCode}>
                ...
                <div style={styles.heroContent}>
                    ...
                    {!loading && bookings.length > 0 && (
                        <div style={styles.heroStats}>
                            {[
                                { val: bookings.length, label: 'Total Bookings', color: '#60a5fa' },
                                { val: confirmed, label: 'Confirmed', color: '#22c55e' },
                                { val: cancelled, label: 'Cancelled', color: '#ef4444' },
                                { val: `₹${totalSpent}`, label: 'Total Spent', color: '#f59e0b' },
                            ].map((s, i) => (
                                        ...
                                        <div style={styles.detailsGrid}>
                                            {[
                                                ...
                                                <div key={i} style={styles.detailBox}>
                                                    ...
                                                    <p style={{...styles.detailVal, color: i === 2 ? cfg.color : '#ffffff'}}>
                                                        {d.val}
                                                    </p>
                                                </div>
                                            ))}
...
const styles = {
    ...
    heroOverlay: {
        position: 'absolute', inset: 0,
        background: 'linear-gradient(180deg, rgba(5,10,20,0.6) 0%, rgba(5,10,20,0.97) 100%)',
    },
    ...
    heroTitle: {
        ...
        color: '#ffffff', fontSize: '60px',
        letterSpacing: '3px', margin: '0 0 8px 0',
    ...
    heroStatVal: {
        fontFamily: "'Bebas Neue', sans-serif",
        fontSize: '30px', letterSpacing: '1px', margin: '0 0 2px 0',
    },
    ...
    cancelBtn: {
        ...
        border: '1px solid #ef444444', padding: '9px 16px',
        borderRadius: '8px', cursor: 'pointer',
        fontSize: '13px', fontWeight: '700',
        transition: 'all 0.2s',
    },
    ...
    playerNum: {
        ...
        color: '#000', fontSize: '12px', fontWeight: '800', flexShrink: 0,
    },
    ...
    ctaBox: {
        ...
        padding: '32px', background: '#111827',
