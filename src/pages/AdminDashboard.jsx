...
//     // Load users separately so it doesn't crash everything
//     try {
...
//         .reduce((sum, b) => sum + (b.turf?.pricePerHour || 0), 0);
...
//                 .quick-btn:hover { opacity: 0.85; transform: translateY(-2px); }
...
//                         <p style={styles.loadingTxt}>⏳ Loading dashboard data...</p>
//                     </div>
//                 ) : (
//                     <>
//                         {/* OVERVIEW TAB */}
...
//                                     {[
//                                         { label: 'Total Users', value: stats.totalUsers || users.length || 0, icon: '👥', color: '#60a5fa', bg: '#0c1a3a', change: 'Registered users' },
//                                         { label: 'Total Turfs', value: stats.totalTurfs || 0, icon: '🏟️', color: '#4ade80', bg: '#052e16', change: 'Active turfs' },
//                                         { label: 'Total Bookings', value: stats.totalBookings || bookings.length || 0, icon: '📋', color: '#fb923c', bg: '#3a1a00', change: 'All time' },
//                                         { label: "Today's Bookings", value: stats.todayBookings || 0, icon: '📅', color: '#e879f9', bg: '#2a0a3a', change: 'Today' },
//                                         { label: 'Confirmed', value: confirmedBookings, icon: '✅', color: '#22c55e', bg: '#052e16', change: 'Active bookings' },
//                                         { label: 'Cancelled', value: cancelledBookings, icon: '❌', color: '#ef4444', bg: '#1a0808', change: 'Cancelled' },
//                                         { label: 'Total Revenue', value: `₹${revenue}`, icon: '💰', color: '#f59e0b', bg: '#2d1f00', change: 'From confirmed' },
//                                         { label: 'Avg per Booking', value: bookings.length ? `₹${Math.round(revenue / (confirmedBookings || 1))}` : '₹0', icon: '📈', color: '#a3e635', bg: '#1a3a00', change: 'Per booking' },
//                                     ].map((s, i) => (
...
//                                                 <span style={{...styles.statChange, color: s.color + 'aa'}}>{s.change}</span>
//                                             </div>
...
//                                             { label: 'View Bookings', icon: '📋', color: '#60a5fa', desc: 'See all user bookings', action: () => setActiveTab('bookings') },
...
//                                             >
//                                                 <span style={{fontSize: '36px'}}>{q.icon}</span>
//                                                 <div>
...
//                                             <p style={{color: '#94a3b8', fontSize: '16px'}}>No bookings yet!</p>
//                                         </div>
//                                     ) : (
...
//                                                             <td style={{...styles.td, color: '#22c55e', fontWeight: '700', fontFamily: 'monospace'}}>{b.bookingCode}</td>
//                                                             <td style={styles.td}>{b.user?.username || 'N/A'}</td>
//                                                             <td style={styles.td}>{b.turf?.name || 'N/A'}</td>
//                                                             <td style={styles.td}>{b.bookingDate}</td>
//                                                             <td style={styles.td}>{b.slot ? `${b.slot.startTime} - ${b.slot.endTime}` : 'N/A'}</td>
//                                                             <td style={styles.td}>
//                                                                 <span style={{
//                                                                     ...styles.statusBadge,
...
//                                                             <td style={styles.td}>
//                                                                 {b.status === 'CONFIRMED' && (
//                                                                     <button style={styles.cancelBtn} onClick={() => handleCancelBooking(b.id)}>
//                                                                         Cancel
//                                                                     </button>
//                                                                 )}
//                                                             </td>
...
//                                 <div style={styles.secHeader}>
//                                     <h2 style={styles.secTitle}>📋 All Bookings ({bookings.length})</h2>
//                                     <input
...
//                                     ].map((s, i) => (
//                                         <div key={i} style={{...styles.miniStat, border: `1px solid ${s.color}33`}}>
...
//                                                         <td style={styles.td}>
//                                                             <div>
//                                                                 <p style={{color: '#fff', fontWeight: '700', margin: 0, fontSize: '13px'}}>{b.user?.username}</p>
//                                                             </div>
//                                                         </td>
//                                                         <td style={styles.td}>
//                                                             <p style={{color: '#94a3b8', margin: 0, fontSize: '13px'}}>{b.turf?.name}</p>
//                                                             <p style={{color: '#475569', margin: 0, fontSize: '11px'}}>{b.turf?.location}</p>
//                                                         </td>
//                                                         <td style={{...styles.td, color: '#94a3b8', fontSize: '13px'}}>{b.bookingDate}</td>
//                                                         <td style={{...styles.td, color: '#60a5fa', fontSize: '13px', fontWeight: '700'}}>
//                                                             {b.slot ? `${b.slot.startTime} - ${b.slot.endTime}` : 'N/A'}
//                                                         </td>
//                                                         <td style={{...styles.td, color: '#94a3b8', textAlign: 'center'}}>
//                                                             {b.players?.length || 1}
//                                                         </td>
//                                                         <td style={{...styles.td, color: '#f59e0b', fontWeight: '700'}}>
//                                                             ₹{b.turf?.pricePerHour || 0}
//                                                         </td>
//                                                         <td style={styles.td}>
//                                                             <span style={{
//                                                                 ...styles.statusBadge,
...
//                             <div style={styles.tabContent}>
//                                 <div style={styles.secHeader}>
//                                     <h2 style={styles.secTitle}>👥 All Users ({users.length})</h2>
//                                     <input
//                                         style={styles.searchInput}
...
//                                                         <div style={{
//                                                             ...styles.userAvatar,
//                                                             background: u.role === 'ADMIN' ? '#f59e0b22' : '#22c55e22',
//                                                             color: u.role === 'ADMIN' ? '#f59e0b' : '#22c55e',
//                                                         }}>
...
//                                                             <p style={styles.userStatVal}>{userBookings.length}</p>
//                                                             <p style={styles.userStatLabel}>Bookings</p>
//                                                         </div>
//                                                         <div style={styles.userStat}>
//                                                             <p style={{...styles.userStatVal, color: '#22c55e'}}>{userBookings.filter(b => b.status === 'CONFIRMED').length}</p>
//                                                             <p style={styles.userStatLabel}>Active</p>
//                                                         </div>
//                                                         <div style={styles.userStat}>
//                                                             <p style={{...styles.userStatVal, color: '#f59e0b'}}>₹{userRevenue}</p>
//                                                             <p style={styles.userStatLabel}>Spent</p>
//                                                         </div>
//                                                     </div>
//                                                 </div>
//                                             );
...
//     body: { maxWidth: '1300px', margin: '0 auto', padding: '32px' },

//     header: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '28px', flexWrap: 'wrap', gap: '16px' },
//     headerSub: { color: '#64748b', fontSize: '13px', margin: '0 0 4px 0', textTransform: 'uppercase', letterSpacing: '1px' },
//     headerTitle: { fontFamily: "'Bebas Neue', sans-serif", color: '#ffffff', fontSize: '44px', letterSpacing: '2px', margin: '0 0 4px 0' },
//     headerDate: { color: '#475569', fontSize: '13px', margin: 0 },
//     refreshBtn: { background: '#1e293b', color: '#94a3b8', border: '1px solid #334155', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer', fontSize: '14px', fontWeight: '700' },

//     tabRow: { display: 'flex', gap: '0', borderBottom: '1px solid #1e293b', marginBottom: '28px' },
//     tabBtn: { background: 'none', border: 'none', padding: '12px 24px', cursor: 'pointer', fontSize: '15px', fontWeight: '700', transition: 'all 0.2s' },

//     loadingBox: { textAlign: 'center', padding: '80px' },
//     loadingTxt: { color: '#94a3b8', fontSize: '18px' },

//     statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px', marginBottom: '28px' },
//     statCard: { borderRadius: '12px', padding: '20px' },
//     statTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' },
//     statIcon: { fontSize: '28px' },
//     statChange: { fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px' },
//     statVal: { fontSize: '36px', fontWeight: '800', margin: '0 0 4px 0', fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '1px' },
//     statLabel: { color: '#64748b', fontSize: '13px', margin: 0 },

//     quickSection: { marginBottom: '28px' },
//     quickGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '16px', marginTop: '16px' },
//     quickCard: { background: '#111827', borderRadius: '12px', padding: '20px', display: 'flex', alignItems: 'center', gap: '16px' },
//     quickLabel: { fontSize: '16px', fontWeight: '800', margin: '0 0 4px 0' },
//     quickDesc: { color: '#64748b', fontSize: '13px', margin: 0 },

//     recentSection: { marginBottom: '28px' },
...
//     th: { padding: '14px 16px', color: '#64748b', fontSize: '12px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px', textAlign: 'left', whiteSpace: 'nowrap', borderBottom: '1px solid #1e293b' },
...
//     cancelBtn: { background: '#ef444422', color: '#ef4444', border: '1px solid #ef444444', padding: '6px 12px', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', fontWeight: '700', whiteSpace: 'nowrap' },
...
//     miniStat: { background: '#111827', borderRadius: '10px', padding: '14px 20px', textAlign: 'center', minWidth: '100px' },
//     miniStatVal: { fontSize: '24px', fontWeight: '800', margin: '0 0 4px 0' },
//     miniStatLabel: { color: '#64748b', fontSize: '12px', margin: 0, textTransform: 'uppercase', letterSpacing: '0.5px' },
...
//     userCard: { background: '#111827', borderRadius: '12px', padding: '20px', border: '1px solid #1e293b' },
//     userCardTop: { display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' },
...
//     userStats: { display: 'flex', gap: '0', background: '#0f172a', borderRadius: '8px', overflow: 'hidden' },
